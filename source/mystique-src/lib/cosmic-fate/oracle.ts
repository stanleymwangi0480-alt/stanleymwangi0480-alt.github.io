/**
 * @fileOverview Full unabridged Personal Year oracles for the Year Dive section.
 */
export const YD: Record<number, any> = {
  1: {
...
Fresh starts receive energetic support across all life domains: career initiations, relocation, relationship beginnings, and identity transformations. Even those with cooperative Life Path numbers experience increased self-assertion and initiative — this is the yearly force of the monad asserting itself through your personal cycle, regardless of your natal orientation.`,
    esoteric: `THE BURDEN OF THE ARCHITECT: This is a year of radical isolation. You are the only one who can see the vision. It requires the "death" of your former identity to make room for the new seed. The focus is the emergence of the "Self" from the void.`,
...
In Chaldean practice, the name's total value interacting with Year 1's vibration reveals whether the cycle opens through inspiration (high-vibration compound) or through karmic clearing (13/4 energy carried into Year 1's threshold). Professional name analysis during Year 1 can clarify which pathway the cycle is opening.`,
    pr: [
      { i: "🌅", n: "Solar Meditation", d: "Sunrise practice facing east, breathing gold light into solar plexus" },
      { i: "🙏", n: "Surya Namaskar", d: "12-round sun salutation cycle, embodying forward movement" },
      { i: "🎯", n: "Vision Architecture", d: "Nine-year arc visualization; commit to 1–3 core initiatives only" },
      { i: "⚡", n: "Yang Qigong", d: "Rising energy cultivation through morning movement practice" }
    ]
  },
  2: {
...
The year's primary opportunities center on relationship development: romantic partnerships deepening or forming, professional collaborations benefiting from enhanced diplomatic skill, community connections strengthening through increased social sensitivity. Intuitive development — less obvious but equally important — reaches a peak: the receptive yin energy heightens sensitivity to emotional undercurrents, unspoken needs, and emerging patterns that Year 1's action-orientation would have missed.`,
    esoteric: `THE PSYCHIC SPONGE: This isn't just about "waiting"; it's about developing extreme receptivity. You are learning to be "second" so you can understand the nuances of energy and intuition. The focus is the emergence of the "Self" from the void.`,
...
The 29/2 carries the "Grace under pressure" vibration — extraordinary emotional resilience developed precisely through being pressed beyond comfortable limits. Year 2 reducing from 29 brings challenges that develop the emotional mastery that only genuine difficulty can produce.`,
    pr: [
      { i: "🌙", n: "Moon Salutations", d: "Evening Chandra Namaskar practice, attuning to lunar rhythms" },
      { i: "👂", n: "Deep Listening", d: "Daily practice of listening without formulating response" },
      { i: "💧", n: "Dream Journaling", d: "Morning recording of dream imagery and emotional tone" },
      { i: "🤝", n: "Partnership Audit", d: "Honest inventory of all collaborative relationships' health and reciprocity" }
    ]
  },
  3: {
...
The triad's philosophical significance is generative: 1 and 2's polarity produces 3 as their creative offspring. This generative quality means Year 3 often literally produces: artistic works, new projects, relationships, creative businesses, and in some cases children. The year strongly supports: creative business launches, writing and publishing ventures, public speaking and performance, teaching and facilitation, and any work requiring the charismatic engagement of others with an authentic vision.`,
    esoteric: `THE MASK AND THE MIRROR: It is the "adolescence" of the cycle. The challenge is moving beyond superficial charm to find authentic self-expression. It’s about the vulnerability of being truly seen. The focus is the emergence of the "Self" from the void.`,
...
The 30/3 carries exceptional creative power combined with the "loner" tendency — extraordinary gifts paired with difficulty sustaining collaborative frameworks. Year 3 from 30 invites conscious attention to genuine openness to others' contributions rather than using collaboration as a vehicle for solo expression.`,
    pr: [
      { i: "🎨", n: "Daily Creation", d: "15 minutes of uncensored creative expression every morning" },
      { i: "🗣", n: "Throat Mantra", d: "Ham seed mantra vibration practice for Vishuddha activation" },
      { i: "📖", n: "Jupiter Journaling", d: "Evening gratitude extraction and wisdom documentation from each day" },
      { i: "🌱", n: "East Activation", d: "Feng shui Wood element placement in the Eastern sector" }
    ]
  },
  4: {
...
The year's genuine power is structural. Career advancement through demonstrated competence rather than charisma is Year 4's professional signature. Financial foundations built this year through disciplined saving, debt reduction, and investment have the longest-lasting impact of any year in the cycle. Health disciplines established in Year 4 create the physical capacity that Years 5-9 will depend upon. Real estate transactions, organizational system building, and technical skill acquisition all benefit from the year's structural momentum.`,
    esoteric: `THE ANVIL: While most call this "hard work," it is actually about ancestral patterns. It is the year you confront the foundations laid by your parents and society. It feels restrictive because you are being compressed into a diamond. It is the illusion of "no progress" while the roots are growing deep. NOTE: This is an incubation period. The lack of external movement is a sign of internal intensity.`,
...
The 31/4 emphasizes individual creative craftsmanship — building through the genius of singular excellence rather than through systematic frameworks. Those in 31/4 years must resist isolation, recognizing that their craft reaches its highest expression through the discipline of genuine engagement with others rather than solo perfection.`,
    pr: [
      { i: "🌍", n: "Grounding Practice", d: "Daily barefoot earth contact; root chakra meditation before work" },
      { i: "📊", n: "Financial Architecture", d: "Build one solid financial system: budget, savings automation, debt plan" },
      { i: "🏋️", n: "Physical Discipline", d: "Non-negotiable daily health routine; consistency over intensity always" },
      { i: "🔧", n: "Skill Mastery", d: "One technical skill pursued to genuine competence through this year" }
    ]
  },
  5: {
...
Budha's remedial practices: mercurial rituals on Wednesdays, green gemstones (emerald for Mercury mahadasha holders), pranayama for nervous system regulation, and deliberate integration practices — regular periods of silence and stillness to process the extraordinary volume of Year 5's incoming information.`,
...
The 32/5 (Communication Mastery) suggests Year 5's liberation finds its highest expression not necessarily in physical adventure but in the mastery of expressive communication — the spoken word, written language, or artistic medium becoming the vehicle of genuine transformation for oneself and others.`,
    pr: [
      { i: "✈️", n: "Intentional Adventure", d: "Plan one meaningful journey beyond your established comfort zone" },
      { i: "🧘", n: "Pranayama", d: "Daily breathwork for nervous system regulation, integration, and clarity" },
      { i: "📚", n: "Edge Learning", d: "Study one discipline completely outside your established expertise" },
      { i: "💚", n: "Heart Opening", d: "Anahata practices: loving-kindness meditation, heart coherence breathing" }
    ]
  },
  6: {
...
Marriage and committed partnership receive Year 6's strongest support — numerological tradition consistently identifies it as the cycle's most favorable year for formal relationship commitment. Significant creative partnerships also thrive under Venus's governance. Home improvement, domestic beautification, and establishing genuinely nurturing environments yield satisfaction that outlasts the year.`,
    esoteric: `THE GOLDEN HANDCUFFS: Usually labeled "responsibility/family," the deeper meaning is The Karmic Mirror. You attract exactly the level of harmony (or discord) that you hold within. It’s a year of "Sacred Service" versus "Slavery"—learning the difference between helping others and losing yourself.`,
...
Practices for Year 6: Friday evening Venus rituals (white flowers, natural fragrances, aesthetic cultivation), creative practices dedicated to others' benefit, and the specific practice of beauty-making as spiritual discipline — creating genuinely beautiful environments as an offering to all who inhabit them.`,
...
The Helpful People sector's activation makes Year 6 the cycle's best year for cultivation of genuinely mutual relationships — not transactional networking but the development of connections rooted in shared values and complementary strengths. The annual 6 White Star brings heaven's luck wherever it visits — identify and specifically enhance this sector in your home's annual floor plan for Year 6.

Feng shui for Year 6: Northwest sector with Metal element (round metallic objects, white and gold color palette), mentorship imagery, and representations of the beneficial relationships you wish to cultivate. The Qian energy specifically responds to images of genuine authority.`,
    chald: `The 15/6 (Magician) represents Year 6's most auspicious compound in Chaldean practice — the unusual capacity to attract both material support and protective spiritual forces through genuine beauty cultivation and service. 15/6 years carry an almost magical quality of right-place-right-time encounters with precisely the people and resources needed.
...
The 33/6 master number brings Year 6's service orientation to its highest possible expression — a year when care for others becomes genuinely healing rather than merely helpful, when creative service touches the soul level, when the individual's authentic loving presence becomes itself a transformative force in others' lives.`,
    pr: [
      { i: "💐", n: "Venus Ritual", d: "Friday evening beauty ritual honoring what you genuinely love and serve" },
      { i: "🏠", n: "Home Sanctuary", d: "Beautify your living space as a conscious offering to all who inhabit it" },
      { i: "🎭", n: "Creative Service", d: "Offer your specific creative gift in service of a genuine community need" },
      { i: "⚖️", n: "Service Audit", d: "Are you giving freely from abundance or from obligation? Recalibrate honestly." }
    ]
  },
  7: {
...
Ketu remedial practices: Ketu mantra (Om Ketave Namah), gray and smoky tones in key spaces, cat's-eye gemstone (for those in Ketu mahadasha), regular fasting and simplification practices, and extended periods of complete silence.`,
...
The lake's stillness is Year 7's fundamental invitation. Feng shui for Year 7: West sector enhancement with Metal element (round metal objects, white and gray tones, crystalline structures that reflect light), deliberate creation of retreat space within the living environment, and removal of visual clutter from key living areas. The annual 7 Red Star brings volatility, potential for arguments, and theft risk.
...
The 34/7 (Revelator) promises exceptional spiritual authority and truth-speaking capacity — Year 7 when the individual's deepest knowing finds its most eloquent expression, often through writing, teaching, or creative work of unusual psychological and spiritual depth.`,
    pr: [
      { i: "🔮", n: "Meditation Intensive", d: "Establish daily 20+ minute sit; explore one lineage with genuine depth" },
      { i: "📜", n: "Deep Study", d: "One area of profound intellectual or spiritual inquiry, pursued to genuine depth" },
      { i: "🌌", n: "Ajna Activation", d: "Third eye practices: trataka flame gazing, inner light meditation, active dreamwork" },
      { i: "🌿", n: "Radical Simplification", d: "Remove what is genuinely inessential from environment, schedule, and mind" }
    ]
  },
  8: {
    title: "Year of Power",
...
Saturn governs Year 8 — the great disciplinarian, lord of karma, time, authority, limitation, and the harvest of what has been genuinely earned over the preceding seven years. Saturn does not negotiate or accept excuses, and rewards nothing that has not been genuinely developed. This makes Year 8 simultaneously the cycle's most potentially rewarding and most potentially confronting year.

The Octad's symbolic significance — eight as infinity rotated, the octave that is simultaneously completion and beginning of a new scale — points to Year 8 as the cycle's moment of fullest material manifestation. Career authority claims, business expansion, executive leadership, real estate investment, and the assumption of genuine institutional responsibility all receive Year 8's support.`,
    esoteric: `THE MIRROR OF MERIT: It’s not just about "money and power." It is the Cosmic Harvest. In Year 8, the universe reflects your integrity back to you in material form. If you’ve cheated the process in years 1–7, Year 8 brings a "reaping." If you’ve worked with heart, it brings "expansion." It is the mastery of the flow between "as above, so below."`,
...
Saturn remedial practices: Om Sham Shanicharaya Namah mantra practice (especially on Saturdays), blue sapphire (for those in Saturn mahadasha), disciplined fasting practices, and systematic service to the elderly and disabled.`,
    chinese: `Year 8 maps to the Northeast — Gen trigram (Keeping Still, Earth element), associated with knowledge, self-cultivation, and the mountain's inherent authority. The mountain commands not by assertion but by virtue of what it genuinely is — the most profound teaching about Year 8's authority. The Saturnian harvest is the mountain's harvest: immovable, self-sufficient, commanding by nature.

In Chinese cultural numerology, 8 (bā) resonates with prosperity and is considered the most auspicious single digit. Year 8's material auspiciousness is genuine but specifically conditional: the 8's good fortune flows to those whose foundation (Year 4's work) was genuinely built rather than performed. The cultural 8-resonance amplifies what is already genuine.

Feng shui for Year 8: Northeast sector activation with Earth element (crystals, stones, ceramics, square shapes, yellow and beige tones). The annual 8 White Star is the system's most auspicious star — identify the sector it visits in your home's annual floor plan and enhance it.`,
...
The 26/8 (Saturnian authority with collective responsibility) brings success alongside significant weight of responsibility for others' wellbeing. The 26/8 year's central karmic test: using genuine power in service of collective benefit rather than personal advantage. Those who pass this test receive Saturn's fullest blessing.

The 35/8 rewards creative achievement elevated to institutional significance — the craftsperson whose mastery becomes culturally recognized, the artist whose work achieves lasting institutional presence, the thinker whose framework becomes the field's standard.`,
    pr: [
      { i: "📋", n: "Karmic Accounting", d: "Honest inventory of what you've genuinely built; consciously release illusions" },
      { i: "🏆", n: "Authority Claim", d: "Apply for, seek, or consciously accept the leadership role you've genuinely earned" },
      { i: "🕰️", n: "Saturn Discipline", d: "Establish one non-negotiable daily practice and honor it with complete consistency" },
      { i: "🌾", n: "Harvest Gratitude", d: "Ritually acknowledge every genuine fruit of the preceding seven years" }
    ]
  },
  9: {
...
Simultaneously ending and beginning, this year provides the genuine opportunity to complete with consciousness — to end what needs ending with grace and gratitude rather than through abandonment or resentment. Service work of the most impersonal kind — giving with genuinely no expectation of personal return — flows with extraordinary ease in Year 9's completion energy. Creative work that synthesizes and summarizes the entire cycle's learning produces works of unusual depth and lasting resonance.`,
    esoteric: `THE GREAT EMPTYING: Often feared as "endings," this is actually a Womb-like State. You are "burning the fields" so the soil can rest. The deeper work here is radical detachment. You aren't just losing things; you are clearing the space so that the Year 1 version of you has a place to land.`,
...
The 27/9 (Sceptre, wisdom recognized) promises that accumulated wisdom receives its fullest recognition and most effective expression this year. The 36/9 carries humanitarian achievement — personal completion opening naturally into collective service, individual journey becoming a gift to community simply through the authentic completeness of its telling.`,
    pr: [
      { i: "🕯️", n: "Completion Ritual", d: "Ceremonially close each significant chapter with genuine gratitude and release" },
      { i: "🌊", n: "Grief Honoring", d: "Allow and fully witness the natural grief of genuine ending without bypassing" },
      { i: "✍️", n: "Cycle Summary", d: "Write the story of these nine years: what was planted, built, harvested, released" },
      { i: "🌱", n: "Seed Visioning", d: "What genuinely wants to be born in the next Year 1? Plant it as clear intention." }
    ]
  }
};
